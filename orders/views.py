...
def place_order(request, total = 0, quantity=0, ):
    ...
    #if cart count less than zero redirect back to shop
    ...
    print('was this even called2')
    if request.method == 'POST':
        print('was this even called3')
        form = OrderForm(request.POST)
        a=1
        if form.is_valid():
        #if a==1:
            print('was this even called4')
            #store all the billing information
            print('tried valid form')
            data = Order()
